...
def mainLoop():
    ...
    try:
        ...
        print("Cozmo says: Yeeeeesh " + user_name + "?")
    except:
        bot.browser.close()
...
def check_quit():
    ...
    if activate and command:
        ...
        print("OK " + user_name + ". Bye for now. Returning to FreePlay mode.")
        AIBot().browser.quit()
        freeplay()
        mainLoop()
    else:
...
def wake_up():
    ...
    print("Cozmo says: " + greet + user_name + ".")

# Here take the robot to the chatbot for one round and if user times out then go to freeplay.
